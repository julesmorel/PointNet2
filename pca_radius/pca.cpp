...
int main(int argc, char *argv[]){
  ...
  pcl::getMinMax3D (pts, minPt, maxPt);
  double deltaX = maxPt.x - minPt.x;
  double deltaY = maxPt.y - minPt.y;
  ...
  for(int i=0;i<pts.size();i++){
    ...
    int numberN =  kdtree.radiusSearch(currentPt,radius,k_indices,k_sqr_distances);
